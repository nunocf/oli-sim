...
--
--
-- -- | ReplicateAmountInputChange Int
--
-- type alias Mdl =
--     Material.Model
--
...
--             Nothing
--
--         GenomeCopyInputChange newGenomeCopyNumber ->
--             ( { model | genomeCopyNumber = ConversionUtils.convertToInt newGenomeCopyNumber 0 }, Cmd.none ) |> Just
--
--         SampleCodeInputChange newSampleCode ->
--             ( { model | sampleCode = newSampleCode }, Cmd.none ) |> Just
--
--     -- Mdl msg_ ->
...
--     div []
--         [ div []
--             [ label [] [ text "Genome Copy number:" ]
--             , input [ type_ "text", placeholder "GC number", onInput GenomeCopyInputChange ] [ text (toString model.genomeCopyNumber) ]
--             ]
--         , div []
--             [ label [] [ text "Sample Code:" ]
--             , input [ type_ "text", placeholder "sample1", onInput SampleCodeInputChange ] [ text model.sampleCode ]
--             ]
--         , div []
--             [
--             ]
...
-- -- convertToInt string errDefault =
